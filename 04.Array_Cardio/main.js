...
console.table(fullNameInventors);

// Array.prototype.sort()
// 3. Sort the inventors by birthdate, oldest to youngest
const oldestToYoungest = inventors.sort((young, old) => {
  return young.year - old.year;
});
console.table(oldestToYoungest);

// Array.prototype.reduce()
// 4. How many years did all the inventors live all together?
const yearsLiveEach = inventors
  .map((inventor) => inventor.passed - inventor.year)
  .reduce((sum, year) => sum + year, 0);
console.log(yearsLiveEach);
